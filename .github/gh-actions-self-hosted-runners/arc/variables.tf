...
variable "main_runner" {
    type = object({
      ...
      runner_image = optional(string, "us-central1-docker.pkg.dev/apache-beam-testing/beam-github-actions/beam-arc-runner:2ad06b3cdcd217d3068e2b473ea1112364e22f07")
